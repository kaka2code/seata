...
import static io.seata.spring.boot.autoconfigure.StarterConstants.TCC_FENCE_CONFIG_PREFIX;
...
public class SeataClientPropertiesAutoConfiguration {
    static {
        ...
        PROPERTY_BEAN_MAP.put(TCC_FENCE_CONFIG_PREFIX, TCCFenceProperties.class);
    }
}
